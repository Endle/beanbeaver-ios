    ...
    var body: some View {
        List {
            Section {
                ...
                Text("Only written while \"Store detailed debug info\" is on. Each entry is either a full copy of one scan's parsed contents (items, prices, the raw OCR text and its detection boxes, and the generated ledger entry) or the detail behind a failed ledger export.")
            }
        }
